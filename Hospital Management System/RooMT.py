...
def Room_all():
    ...
    rootR.geometry("1550x900")
    r_head=tkinter.Label(rootR,text="ROOM ALLOCATION",font='Times 23 bold',fg="dark grey")
    ...
    L=['SINGLE ROOM : Rs 4500','DOUBLE SHARING : Rs2500','TRIPLE SHARING : Rs2000']
    ...
    L1=['1-SINGLE ROOM','2-SINGLE ROOM','3-SINGLE ROOM','4-SINGLE ROOM','5-SINGLE ROOM','6-DOUBLE SHARING','7-DOUBLE SHARING','8-DOUBLE SHARING','9-DOUBLE SHARING','10-DOUBLE SHARING','11-DOUBLE SHARING','12-DOUBLE SHARING','13-DOUBLE SHARING','14-TRIPLE SHARING','15-TRIPLE SHARING','16-TRIPLE SHARING','17-TRIPLE SHARING','18-TRIPLE SHARING','19-TRIPLE SHARING']
    room_no = tkinter.Listbox(rootR, width=20, height=1, selectmode='SINGLE', exportselection=0)
    for j in L1:
